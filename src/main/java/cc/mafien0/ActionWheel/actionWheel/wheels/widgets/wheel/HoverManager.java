...
/**
 * Counts hover time for elements that should smoothly react on hovering Example: Wheel widget
 * action tickHover should be updated every frame
 */
public class HoverManager {
  ...
  /**
   * Returns hover progress in range from 0 (not hovered) to 1 (hovered over element for
   * [maxHoverTime] ticks)
   *
   * @return
   */
