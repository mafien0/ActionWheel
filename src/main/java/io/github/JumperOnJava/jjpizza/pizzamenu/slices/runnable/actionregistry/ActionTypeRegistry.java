...
public class ActionTypeRegistry {
  ...
  private static class PizzaAdapter
      implements JsonSerializer<PizzaManager>, JsonDeserializer<PizzaManager> {
    @Override
    public PizzaManager deserialize(
        JsonElement json, Type typeOfT, JsonDeserializationContext context)
        throws JsonParseException {
      return null;
    }
    ...
    @Override
    public JsonElement serialize(
        PizzaManager src, Type typeOfSrc, JsonSerializationContext context) {
